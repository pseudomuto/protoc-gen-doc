...
LABEL maintainer="pseudomuto <david.muto@gmail.com>" protoc_version="3.19.4"

WORKDIR /

ADD https://github.com/google/protobuf/releases/download/v3.19.4/protoc-3.19.4-linux-x86_64.zip ./
